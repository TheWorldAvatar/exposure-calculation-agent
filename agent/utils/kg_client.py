...
from agent.utils.stack_configs import BLAZEGRAPH_URL, ONTOP_URL, BLAZEGRAPH_DEFAULT_URL, STACK_OUTGOING_URL
...
class KgClient():
    def __init__(self):
        ...
        self.remote_store_client_federate = baselib_view.RemoteStoreClient(
            STACK_OUTGOING_URL)
