...
CLOSEST_DISTANCE = PREFIX_EXPOSURE + 'ClosestDistance'
TOTAL_LENGTH = PREFIX_EXPOSURE + 'TotalLength'
...
RASTER_AVERAGE = PREFIX_EXPOSURE + 'RasterAverage'
AREAL = PREFIX_EXPOSURE + 'Areal'
AVERAGE = PREFIX_EXPOSURE + 'Average'
WEIGHTED_AVERAGE = PREFIX_EXPOSURE + 'WeightedAverage'
...
CALCULATION_TYPES = [SIMPLE_COUNT, SIMPLE_AREA, CLOSEST_DISTANCE,
                     AREA_WEIGHTED_SUM, RASTER_COUNT, RASTER_AREA, RASTER_AVERAGE, TOTAL_LENGTH, AREAL, AVERAGE, WEIGHTED_AVERAGE] + TRAJECTORY_TYPES
