...
def retrieve_stack_settings():
    ...
    global BLAZEGRAPH_URL, ONTOP_URL, RDB_URL, RDB_USER, RDB_PASSWORD, ONTOP_CLIENT, BLAZEGRAPH_DEFAULT_URL, STACK_OUTGOING_URL
    try:
        ...
        STACK_OUTGOING_URL = stack_clients_view.Rdf4jClient.getInstance(
